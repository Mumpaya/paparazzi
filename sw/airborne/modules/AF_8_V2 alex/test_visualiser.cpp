...
/* ================================================================
 * VISUALISATION SUPPORT (copied & adapted from AF_8_V2)
 * ================================================================ */

/*
 * This file is intentionally almost identical to the original AF_8_V2
 * visualiser. The only changes are default folders pointing to the
 * AF_8_V2_Improved playground, and any small signature adjustments
 * necessary to work with the improved nodes in this directory.
 *
 * We keep the same HUD, 3-panel layout, and bottom-camera popup.
 */
